 ...
 */
export function modifyCarrito(idProduct, cantidad){
  const products = getProducts();
  ...
  //Si tiene 10 y se le pasa -1 -> 10 - (1)
  //Si tiene 10 y se le pasa 1 -> 10 - (-1) 10 +1
  productInDB.quantity = productInDB.quantity + cantidad;

  //Si tiene 5 y se le pasa -1 -> 5 - (-1 * -1) = 5 - 1
  //Si tiene 5 y se le pasa 1 -> 5 - (1 * -1) = 5 + 1
 ...
 * @param {number} cantidad Representa la cantidad a sumar
 */
